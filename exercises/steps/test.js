const steps = require('./index').steps
const steps2 = require('./index').steps2
const steps3 = require('./index').steps3
...
describe('Course Solution - nested for',()=>{
  beforeEach(() => {
    jest.spyOn(console, 'log');
  });
...
describe('Course Solution - recursion',()=>{
  beforeEach(() => {
    jest.spyOn(console, 'log');
  });
