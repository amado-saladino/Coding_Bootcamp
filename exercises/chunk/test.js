...
const chunk2 = require('./index').chunk2
const chunk3 = require('./index').chunk3

describe('My Solution - ciel & splice',()=>{
...
describe('Course Solution - for of loop',()=>{
  test('function chunk exists', () => {
...
describe('Course Solution - slice',()=>{
  test('function chunk exists', () => {
    expect(typeof chunk3).toEqual('function');
  });
